...
**Status:** Phase 2.1 complete on `main` (PR #27 merged); Phase 2.2 complete on `main` (PR #29 merged); Phase 2.3 complete on `main` (PR #30 merged — step 9 implemented as `DefaultHierarchyBootstrapper`); phases 2.4 / 2.5 / 2.6 in this PR (steps 10–19); phases 2.7–2.10 in planning.
